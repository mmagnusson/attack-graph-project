...
export const TECHNIQUES: Technique[] = [
  ...
  { id: "T1685", name: "Disable or Modify Tools", tactic: "TA0112", baseCriticality: 0.9 },
...
export const EDGES: Edge[] = [
  ...
  { from: "T1059", to: "T1685" }, { from: "T1059", to: "T1070" },
  { from: "T1547", to: "T1059" }, { from: "T1546", to: "T1059" },
  { from: "T1068", to: "T1003" }, { from: "T1134", to: "T1003" },
  { from: "T1548", to: "T1003" },
  { from: "T1068", to: "T1055" }, { from: "T1134", to: "T1685" },
  { from: "T1055", to: "T1003" }, { from: "T1685", to: "T1003" },
  ...
  { from: "T1041", to: "T1486" },
  { from: "T1055", to: "T1082" }, { from: "T1685", to: "T1046" },
  { from: "T1557", to: "T1071" },
];
...
export const ATTACK_CHAINS: AttackChain[] = [
  {
    ...
    sector: "government",
    path: ["T1199", "T1059", "T1543", "T1685", "T1003", "T1087", "T1021", "T1005", "T1071", "T1041"],
    severity: 0.95,
  },
  {
  ...
  },
  {
    ...
    sector: "all",
    path: ["T1595", "T1190", "T1059", "T1136", "T1548", "T1685", "T1003", "T1046", "T1021", "T1486"],
    severity: 0.85,
  },
  {
    name: "Lazarus Group",
  ...
  },
  {
    ...
    sector: "all",
    path: ["T1078", "T1047", "T1543", "T1068", "T1685", "T1110", "T1046", "T1570", "T1560", "T1071", "T1486"],
    severity: 0.85,
  },
];
