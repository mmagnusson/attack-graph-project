  ...
  tools: {
    "crowdstrike-falcon": {
      ...
      techniques: {
        ...
        "T1027": { detect: 0.82, prevent: 0.55, source: "ER7" }, "T1685": { detect: 0.78, prevent: 0.50, source: "ER7" },
    ...
    "ms-defender-endpoint": {
      ...
      techniques: {
        ...
        "T1685": { detect: 0.82, prevent: 0.58, source: "ER6" }, "T1070": { detect: 0.78, prevent: 0.42, source: "ER6" },
    ...
    "sentinelone": {
      ...
      techniques: {
        ...
        "T1027": { detect: 0.80, prevent: 0.52, source: "ER6" }, "T1685": { detect: 0.75, prevent: 0.48, source: "ER6" },
    ...
    "cortex-xdr": {
      ...
      techniques: {
        ...
        "T1027": { detect: 0.82, prevent: 0.56, source: "ER6" }, "T1685": { detect: 0.80, prevent: 0.52, source: "ER6" },
    ...
    "cybereason": {
      ...
      techniques: {
        ...
        "T1685": { detect: 0.72, prevent: 0.45, source: "ER7" }, "T1070": { detect: 0.70, prevent: 0.38, source: "ER7" },
      },
    },
    "eset": {
      display_name: "ESET",
    ...
    "sophos": {
      ...
      techniques: {
        ...
        "T1543": { detect: 0.74, prevent: 0.52, source: "ER7" }, "T1685": { detect: 0.72, prevent: 0.46, source: "ER7" },
      },
    },
    "trendmicro": {
      ...
      techniques: {
        ...
        "T1071": { detect: 0.70, prevent: 0.42, source: "ER7" }, "T1685": { detect: 0.74, prevent: 0.48, source: "ER7" },
    ...
    "splunk-es": {
      ...
      techniques: {
        ...
        "T1685": { detect: 0.70, prevent: 0.0, source: "Sigma" }, "T1070": { detect: 0.68, prevent: 0.0, source: "Sigma" },
    ...
    "ms-sentinel": {
      ...
      techniques: {
        ...
        "T1685": { detect: 0.72, prevent: 0.0, source: "Vendor" }, "T1070": { detect: 0.65, prevent: 0.0, source: "Vendor" },
    ...
    "elastic-security": {
      ...
      techniques: {
        ...
        "T1685": { detect: 0.65, prevent: 0.0, source: "Sigma" }, "T1003": { detect: 0.74, prevent: 0.0, source: "Sigma" },
    ...
    "qradar": {
      ...
      techniques: {
        ...
        "T1685": { detect: 0.60, prevent: 0.0, source: "Vendor" }, "T1036": { detect: 0.62, prevent: 0.0, source: "Vendor" },
    ...
    "arctic-wolf": {
      ...
      techniques: {
        ...
        "T1685": { detect: 0.64, prevent: 0.0, source: "Vendor" }, "T1036": { detect: 0.66, prevent: 0.0, source: "Vendor" },
  ...
  infrastructure: {
    ...
    "windows-server": {
      ...
      exposes: {
        ...
        "T1036": 0.8, "T1027": 0.75, "T1685": 0.8, "T1070": 0.75,
    ...
    "windows-workstation": {
      ...
      exposes: {
        ...
        "T1036": 0.8, "T1027": 0.75, "T1685": 0.75, "T1070": 0.7,
