...
export const CHAIN_TECHNIQUE_CONTEXT: Record<string, Record<string, string>> = {
  "APT29 / Cozy Bear": {
    ...
    "T1685": "Disabled security logging and tampered with Defender to conceal SUNBURST activity",
  ...
  "LockBit 3.0": {
    ...
    "T1685": "Disabled Windows Defender and other AV products using GMER and Process Hacker",
  ...
  "BlackCat / ALPHV": {
    ...
    "T1685": "Used custom tools to disable endpoint protection and delete volume shadow copies",
...
export const TECHNIQUE_PLATFORMS: Record<string, string[]> = {
  ...
  "T1685": ["Windows", "Linux", "macOS", "Cloud"],
...
export const TECHNIQUE_MITIGATIONS: Record<string, Mitigation[]> = {
  ...
  "T1685": [{ mitreId: "M1022", name: "Restrict File and Directory Permissions" }, { mitreId: "M1024", name: "Restrict Registry Permissions" }, { mitreId: "M1018", name: "User Account Management" }],
